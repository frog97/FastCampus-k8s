...
resource "aws_iam_role" "testhh-iam-role-ec2-instance-bastion2" {
  assume_role_policy = <<POLICY
{
  "Statement": [
    {
...
POLICY
  name                 = "testhh-iam-role-ec2-instance-bastion2"
...
resource "aws_iam_role_policy_attachment" "testhh-iam-role-ec2-instance-bastion_att" {
  role       = aws_iam_role.testhh-iam-role-ec2-instance-bastion2.name
